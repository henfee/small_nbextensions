...
define(["require", "jquery", "base/js/namespace",  'services/config',
    'base/js/utils'], function toc2(require, $, IPython, configmod, utils) {
...
//.....................global variables....
    ...
    var nbcontainer_marginleft = $('#notebook-container').css('margin-left')
    var nbcontainer_marginright = $('#notebook-container').css('margin-right')
    var nbcontainer_width = $('#notebook-container').css('width')
...
//......... utilitary functions............
  ...
  var create_toc_div = function () {
      ...
      .append(
        ...
        .click( function(){
          ...
          if(liveNotebook){
            ...
            IPython.notebook.set_dirty();}
          //$('.toc-item-num').toggle();  
          number_sections ? $('.toc-item-num').show() : $('.toc-item-num').hide()
          //table_of_contents();
          return false;
        })
      ).append(
    ...
    var oldHeight = undefined //IPython.notebook.metadata.toc_position["height"] //undefined
    ...
    $('#toc-wrapper').draggable({
        ...
        if ((ui.position.left<=0) && (sideBar==false)){
          sideBar = true;
          oldHeight = $('#toc-wrapper').css('height');
          if(liveNotebook){
        ...
        if ((ui.position.left>0) && (sideBar==true)) {
          sideBar = false;
          if(liveNotebook){
            IPython.notebook.metadata.toc['sideBar']=false;
            IPython.notebook.set_dirty(); } 
          if (oldHeight==undefined) oldHeight=Math.max($('#site').height()/2,200)
          $('#toc-wrapper').css('height',oldHeight);        
          toc_wrapper.removeClass('sidebar-wrapper').addClass('float-wrapper');
          $('#notebook-container').css('margin-left',nbcontainer_marginleft);
          $('#notebook-container').css('width',nbcontainer_width);   
...
var table_of_contents = function () {
   ...
   // var toc_index=0;
    ...
    cell_toc = undefined;
   // if toc_cell=true, add and update a toc cell in the notebook. 
